...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Photo', fields ['title_slug']
        db.delete_unique('photologue_photo', ['title_slug'])
        ...
        db.alter_column('photologue_gallery', 'title_slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from=('title',), overwrite=False))

        # Changing field 'Photo.title_slug'
        db.alter_column('photologue_photo', 'title_slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', populate_from=('title',), overwrite=False))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Photo.title_slug'
        db.alter_column('photologue_photo', 'title_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        # Adding unique constraint on 'Photo', fields ['title_slug']
        db.create_unique('photologue_photo', ['title_slug'])
    ...
    models = {
        ...
        'photologue.gallery': {
            ...
            'title_slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "('title',)", 'overwrite': 'False'})
        },
