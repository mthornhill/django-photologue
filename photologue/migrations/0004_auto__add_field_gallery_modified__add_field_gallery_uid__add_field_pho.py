...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.modified'
        db.add_column('photologue_gallery', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Gallery.uid'
        db.add_column('photologue_gallery', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Photo.modified'
        db.add_column('photologue_photo', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Photo.uid'
        db.add_column('photologue_photo', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.modified'
        db.delete_column('photologue_gallery', 'modified')

        # Deleting field 'Gallery.uid'
        db.delete_column('photologue_gallery', 'uid')

        # Deleting field 'Photo.modified'
        db.delete_column('photologue_photo', 'modified')

        # Deleting field 'Photo.uid'
        db.delete_column('photologue_photo', 'uid')
